  ...
  group('ApiService', () {
    ...
    test('searchUsers success with query', () async {
      final client = MockClient((request) async {
        ...
        return http.Response(
          jsonEncode([
            {'id': '1', 'name': 'test1', 'language': 'en'},
            {'id': '2', 'name': 'test2', 'language': 'es'},
          ]),
          200,
        );
      });
    ...
    test('searchUsers success empty query', () async {
      final client = MockClient((request) async {
        ...
        return http.Response(
          jsonEncode([
            {'id': '1', 'name': 'user1', 'language': 'en'},
            {'id': '2', 'name': 'user2', 'language': 'es'},
          ]),
          200,
        );
      });
