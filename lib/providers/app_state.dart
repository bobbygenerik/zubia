...
class AppState extends ChangeNotifier {
  ...
  Future<String?> registerAndSaveIdentity(String email, String password, String name, String lang) async {
    final cred = await auth.signUpWithEmailPassword(email, password);
  ...
  Future<String?> signIn(String email, String password) async {
    final cred = await auth.signInWithEmailPassword(email, password);
    if (cred != null && cred.user != null) {
      userId = cred.user!.uid;
