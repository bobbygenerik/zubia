...
class TestTranslateService(unittest.TestCase):
    def setUp(self):
        ...
        # Ensure any leftover side effects or return values from other tests
        # do not leak into these tests (reset_mock does not clear side_effect).
        try:
            translate_service.argostranslate.translate.translate.side_effect = None
            translate_service.argostranslate.translate.translate.return_value = None
        except Exception:
            pass
